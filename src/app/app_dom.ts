...
export function collectAppDom(): AppDom {
  ...
  return {
    ...
    examplesButton: queryElement(".examples-button", HTMLButtonElement),
    manualButton: queryElement(".manual-button", HTMLButtonElement),
    examplesDialog: queryElement("#examples-dialog", HTMLDialogElement),
    examplesForm: queryElement(".examples-form", HTMLFormElement),
    examplesCloseButton: queryElement(".examples-close-button", HTMLButtonElement),
    examplesAccessWordInput: queryElement(".examples-access-word-input", HTMLInputElement),
    examplesLoadListButton: queryElement(".examples-load-list-button", HTMLButtonElement),
    examplesLoadButton: queryElement(".examples-load-button", HTMLButtonElement),
    examplesNameSearchInput: queryElement(".examples-name-search-input", HTMLInputElement),
    examplesGenreSearchInput: queryElement(".examples-genre-search-input", HTMLInputElement),
    examplesSortSelect: queryElement(".examples-sort-select", HTMLSelectElement),
    examplesSortDirectionSelect: queryElement(".examples-sort-direction-select", HTMLSelectElement),
    examplesNotice: queryElement(".examples-notice", HTMLElement),
    examplesList: queryElement(".examples-list", HTMLElement),
    ...
    practiceSyncFineMinusButton: queryElement(".practice-sync-fine-minus-button", HTMLButtonElement),
    practiceSyncFinePlusButton: queryElement(".practice-sync-fine-plus-button", HTMLButtonElement),
    ...
    practiceDisplayMinusButton: queryElement(".practice-display-minus-button", HTMLButtonElement),
    practiceDisplayPlusButton: queryElement(".practice-display-plus-button", HTMLButtonElement),
    practiceDisplayFineMinusButton: queryElement(".practice-display-fine-minus-button", HTMLButtonElement),
    practiceDisplayFinePlusButton: queryElement(".practice-display-fine-plus-button", HTMLButtonElement),
    practiceDisplayResetButton: queryElement(".practice-display-reset-button", HTMLButtonElement),
    practiceDisplayValue: queryElement(".practice-display-value", HTMLElement),
    practiceDisplayPreview: queryElement(".practice-display-preview", HTMLElement),
