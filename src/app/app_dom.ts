...
export function collectAppDom(): AppDom {
  ...
  return {
    ...
    resultTracks: queryElement(".result-tracks", HTMLElement),
    ...
    resultTimingOnTimeCount: queryElement(".result-timing-on-time-count", HTMLElement),
    resultTimingEarlyLateCount: queryElement(".result-timing-early-late-count", HTMLElement),
